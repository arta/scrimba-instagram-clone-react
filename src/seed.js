// NOTE: replace 'bmjpkU8bBWRse2JwKgzOGTv5tUI3' with your
// Firebase auth user id (can be taken from Firebase at the auth section!
// Look for User UID)
  ...
  const users = [
    {
      ...
      username: 'arta',
      fullName: 'Arta Parta',
      emailAddress: 'artaparta@layeredcode.com',
      following: ['2'],
      followers: ['2', '3', '4'],
